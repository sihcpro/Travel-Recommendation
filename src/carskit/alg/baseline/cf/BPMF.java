...
/**
 * BPMF: Salakhutdinov, Ruslan, and Andriy Mnih. "Bayesian probabilistic matrix factorization using Markov chain Monte Carlo." Proceedings of the 25th international conference on Machine learning. ACM, 2008.<p></p>
        ...
        for (int iter = 1; iter <= numIters; iter++) {
            ...
            for (int gibbs = 0; gibbs < 2; gibbs++) {
                ...
                for (int j = 0; j < numItems; j++) {
                    ...
                    SparseVector jv = train.column(j);
