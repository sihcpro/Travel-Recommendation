...
@Configuration("binThold, knn, regLw2, regLw1, regLc2, regLc1, similarity, iters, rc, als")
public class CSLIM_C extends CSLIM {
    ...
    protected void initModel() throws Exception {
        ...
        cDev = new DenseVector(numConditions);
        cDev.init(initMean, initStd);
