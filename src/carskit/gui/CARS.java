...
//
// CARS is free software: you can redistribute it and/or modify
// it under the terms of the GNU General Public License as published by
// the Free Software Foundation, either version 3 of the License, or
// (at your option) any later version.
//
// CARS is distributed in the hope that it will be useful,
...
/**
 * carskit.main.Main Class of the CARS
 *
 * @author Yong Zheng
 *
 */
...
public class CARS {
    ...
    public static String defaultConfigFileName = "setting.conf";
     ...
     */
    public void preset(String configFile) throws Exception {
    ...
    public boolean isBinaryNumber(int number) { int copyOfInput = number; while (copyOfInput != 0) { if (copyOfInput % 10 > 1) { return false; } copyOfInput = copyOfInput / 10; } return true; }

    public int validateDataFormat(String dataPath) throws Exception {
...
//        Logs.debug(rateDao.headerSize());
     ...
     */
    public void cmdLine(String[] args) throws Exception {
        ...
        if (paramOptions.contains("-v")) {
            ...
            System.out.println("CARS version " + version);
            System.exit(0);
        }
    }
...
//        int N;
    ...
    public Recommender getRecommender(SparseMatrix[] data, int fold) throws Exception {
     ...
     */
    public void about() {
        String about = "\nCARS version " + version + ", copyright (C) 2015-2019 Yong Zheng \n\n"
